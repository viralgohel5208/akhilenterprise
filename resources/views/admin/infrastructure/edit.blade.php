...
<div class="container-xxl flex-grow-1 container-p-y">
    <div class="card mb-6">
        ...
        <div class="card-body pt-0">
            <form id="sliderForm" method="POST" action="{{ route('enterprise-admin.infrastructure.update') }}" enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="col-md-12">
                        ...
                        @if(!empty($data->image))
                            <div class="img_Preview">
                                <img src="{{ asset('admin/infrastructure_image') }}/{{ $data->image }}" style="width: 100px;" >
                            </div>
                        @endif
                    </div>
                </div>
