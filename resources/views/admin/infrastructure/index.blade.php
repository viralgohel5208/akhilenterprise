...
<div class="container-xxl flex-grow-1 container-p-y">
    <div class="card mb-6">
        <div class="row" style="border-bottom: 1px solid #ddd;">
            <div class="col-md-6">
                <h5 class="card-header">Infrastructure List</h5>
            </div>
            <div class="col-md-6 mt-4" style="text-align: right;margin-left: -20px;">
                <a href="{{ route('enterprise-admin.infrastructure.add') }}" class="btn btn-secondary create-new btn-primary waves-effect waves-light">
        ...
        <div class="card-datatable table-responsive pt-0">
            <table id="bannerImage" class="table table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>{{ $i }}</td>
                        <td><img src="{{ asset('admin/infrastructure_image') }}/{{ $value['image'] }}" style="width: 50px;"></td>
                        ...
                        @endif
                        <td>
                            <a class="dropdown-item waves-effect cateAction" href="{{ route('enterprise-admin.infrastructure.edit', $value['id']) }}"><i class="ri-pencil-line me-1"></i></a>
        ...
        $(".removeData").click(function(){
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: '/enterprise-admin/infrastructure/delete/' + recID,
                        type: 'POST',
                        data: {
                            "_token": "{{ csrf_token() }}",
                            "recID": recID,
