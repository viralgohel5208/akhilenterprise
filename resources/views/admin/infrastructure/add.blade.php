...
<div class="container-xxl flex-grow-1 container-p-y">
    <div class="card mb-6">
        <h5 class="card-header" style="border-bottom: 1px solid #ddd;">Add Infrastructure</h5>
        <div class="card-body pt-0">
            <form id="sliderForm" method="POST" action="{{ route('enterprise-admin.infrastructure.store') }}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="mt-6">
                    ...
                    <a href="{{ route('enterprise-admin.infrastructure') }}" class="btn btn-outline-secondary">Cancel</a>
                </div>
            </form>
        </div>
    </div>
