...
<div class="container-xxl flex-grow-1 container-p-y">
    <div class="card mb-6">
        <h5 class="card-header" style="border-bottom: 1px solid #ddd;">Edit Certificate</h5>
        <div class="card-body pt-0">
            <form id="sliderForm" method="POST" action="{{ route('enterprise-admin.certificate.update') }}" enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="col-md-12">
                        ...
                        @if(!empty($data->image))
                            <div class="img_Preview">
                                <img src="{{ asset('admin/certificate_images') }}/{{ $data->image }}" style="width: 100px;" >
                            </div>
                        @endif
                    </div>
                </div>
                ...
                <div class="mt-6">
                    ...
                    <a href="{{ route('enterprise-admin.certificate') }}" class="btn btn-outline-secondary">Cancel</a>
                </div>
            </form>
        </div>
    </div>
