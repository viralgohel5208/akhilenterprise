...
<html lang="en">
    <head>
        ...
        <title>Akhil Enterprise | Forgot Password</title>
            ...
            <div class="authentication-inner row m-0">
                ...
                <div class="d-flex col-12 col-lg-5 col-xl-4 align-items-center authentication-bg position-relative py-sm-12 px-12 py-6" style="background-color: #fff;">
                    <div class="w-px-400 mx-auto pt-5 pt-lg-0">
                        ...
                        <form id="forgotPassword" class="mb-5" action="{{ route('admin.forgotpassword.post') }}" method="POST">
                            @csrf
                        ...
                        <div class="text-center">
                            <a href="{{ route('admin.login-view') }}" class="d-flex align-items-center justify-content-center">
                                <i class="ri-arrow-left-s-line scaleX-n1-rtl ri-20px me-1_5"></i> Back to login
                            </a>
                        </div>
                    </div>
                </div>
